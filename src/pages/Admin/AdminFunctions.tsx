export const userHeaders:string[] = ["Name", "Email", "Password", "Role", "Actions"]
...
export const order_headers = ["OrderID", "UserID", "BillingAddress", "TotalAmount", "Status"]

export const orders = [    
            {'OrderID': 1, 'UserID': 123, 'BillingAddress': '123 Main St, City', 'TotalAmount': 100.5, 'Status': 'Pending'},    
            {'OrderID': 2, 'UserID': 456, 'BillingAddress': '456 Elm St, Town', 'TotalAmount': 75.25, 'Status': 'Shipped'},    
            {'OrderID': 3, 'UserID': 789, 'BillingAddress': '789 Oak St, Village', 'TotalAmount': 250.0, 'Status': 'Delivered'},    
            {'OrderID': 4, 'UserID': 123, 'BillingAddress': '321 Pine St, Hamlet', 'TotalAmount': 50.75, 'Status': 'Pending'},    
            {'OrderID': 5, 'UserID': 456, 'BillingAddress': '654 Birch St, Countryside', 'TotalAmount': 150.2, 'Status': 'Shipped'}]
