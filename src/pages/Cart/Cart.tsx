...
import { IonContent, IonList, IonItem, IonLabel, IonButton, IonRow, IonImg, IonText, IonGrid, IonCol, IonIcon, IonInput } from '@ionic/react';
...
const Cart: React.FC = () => {
    ...
    useEffect(() => {
        const subtotal = productItems.slice(0, 4).reduce((acc, product) => acc + product.price, 0);
        setTotal(subtotal);
    }, []);
    ...
    return (
        <Main>
            ...
            <IonRow className={styles.cartRowTotal}>
                <IonText className={styles.total}>
                    Total : ${total}
                </IonText>
            ...
            <IonRow className={styles.cartRow}>
                ...
                <IonCol className={styles.productDetails}>
                    ...
                    <IonItem>
                        ...
                        placeholder="000"
                        value={quantity}
                        onIonChange={() => handleQuantityChange}></IonInput>
                    </IonItem>
                </IonCol>
